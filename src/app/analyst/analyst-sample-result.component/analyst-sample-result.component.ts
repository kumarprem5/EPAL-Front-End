...
@Component({
  selector: 'app-analyst-sample-result',
  imports: [CommonModule, ReactiveFormsModule],
  templateUrl: './analyst-sample-result.component.html',
  styleUrl: './analyst-sample-result.component.css',
})
export class AnalystSampleResultComponent  implements OnInit {
  @Input() sample: any;
